...
export default function About() {
    ...
    return (
        <div className="about-container">
            ...
            <div className="graphics-jpg-container">
                <img alt="graphics-jpg" className="graphics-jpg" src={graphicsJpg}></img>
                <h3>Eva Cortado</h3>
                <p>VD & Grundare</p>
            </div>
            <img alt="footer-svg" className="graphics-footer-styling" src={graphicsFooter}></img>
        </div>
    )
}
